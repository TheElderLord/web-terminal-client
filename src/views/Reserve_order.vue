            ...
            <div class="field mx-auto ">
                <div class="web-serv w-6/12 mx-auto my-4 py-4">
                    <label for="webServices" class="text-white  text-lg">
                      {{ getLang()=="kz"?"Қызметті таңдаңыз":getLang()=="ru"?"Выберите услугу":"Select a service" }}
                    </label>
                    <select v-model="queueId" @change="getDays()" name="webServices" id="sel" class="border-2 border-black rounded-lg   w-full h-12 text-lg">
                      
                        <option :value="service.queueId[0]" v-for="service in services" :key="service.queueId[0]">
                ...
                <div class="days w-6/12 mx-auto my-4 py-4">
                    <label for="days" class="text-white  text-lg">
                        {{ getLang()=="kz"?"Күнді таңдаңыз":getLang()=="ru"?"Выберите дату":"Select a date" }}
                      </label>
                    <select   v-model="day" @change="getTime()" name="days" id="sel" class="border-2 border-black rounded-lg   w-full h-12 text-lg">
                ...
                <div  class="slots w-6/12 mx-auto my-4 py-4">
                    ...
                    <select   v-model="time" name="slots" id="sel" class="border-2 border-black rounded-lg   w-full h-12 text-lg">
